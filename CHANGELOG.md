...
- Added `remote_addr` getter on `ServerSideConnection ` (thanks to [radiantgurl](https://github.com/radiantgurl), PR [#46](https://github.com/Henauxg/bevy_quinnet/pull/46))
